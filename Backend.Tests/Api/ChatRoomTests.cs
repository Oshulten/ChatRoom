...
public class ChatRoomTests(CustomWebAppFactory factory) : IClassFixture<CustomWebAppFactory>
{
    ...
    {
        await _client.PostAsync("api/Chatroom/seed", null);
    }
    ...
    {
        var responseClear = await _client.DeleteAsync("api/Chatroom/clear");
    ...
    {
        await _client.DeleteAsync("api/Chatroom/clear");
